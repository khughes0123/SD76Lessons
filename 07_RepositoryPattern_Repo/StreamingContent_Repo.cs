...
namespace _07_RepositoryPattern_Repo
{
    public class StreamingContent_Repo
    {
        ...
        // Challenge:
        // Write a method that returns a list of family-friendly content

        //Establish class of streaming content
        // set rating == family friendly
        // create for loop that adds rating PG or G to a list
