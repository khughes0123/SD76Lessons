...
namespace _09_StreamingContent_Console.UI
{
    public class ProgramUI
    {
        ...
        private void RemoveContentFromList()
        {
            ...
            Console.WriteLine("Enter a Title to be removed from content:");
            ...
            {
                Console.WriteLine("No content has that Title" );
            }
        ...
        private void SeedContentList()
        {
            ...
            StreamingContent startrek = new StreamingContent("Star Trek", "space <3", Maturity.R, 5.0, GenreType.Drama);

            _repo.AddContentToDirectory(starwar);
            _repo.AddContentToDirectory(startrek);
        }

        private void UpdateContentInList()
        {
            Console.Clear();

            Console.WriteLine("Choose a Title from the following list which you would like to update.");
